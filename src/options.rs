...
static CPUCT: Lazy<RwLock<f32>> = Lazy::new(|| RwLock::new(1.2));
static CPUCT_ROOT: Lazy<RwLock<f32>> = Lazy::new(|| RwLock::new(4.0));
...
static POLICY_TEMPERATURE_ROOT: Lazy<RwLock<f32>> = Lazy::new(|| RwLock::new(3.0));
