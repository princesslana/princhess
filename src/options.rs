...
static CPUCT: Lazy<RwLock<f32>> = Lazy::new(|| RwLock::new(0.9));
static CPUCT_ROOT: Lazy<RwLock<f32>> = Lazy::new(|| RwLock::new(3.0));
...
static POLICY_TEMPERATURE_ROOT: Lazy<RwLock<f32>> = Lazy::new(|| RwLock::new(5.0));
