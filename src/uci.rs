...
pub fn uci() {
    ...
    println!("option name CPuct type string default 1.20");
    println!("option name CPuctRoot type string default 4.00");
    ...
    println!("option name PolicyTemperatureRoot type string default 3.0");
